...
from __main__  import ICommandHandler  # chỉnh lại đường import phù hợp tên dự án của bạn
...
class TodayHandler(ICommandHandler):
    def can_handle(self, command: str) -> bool:
        keywords = ["hôm nay là thứ", "nay là thứ", "hôm nay thứ mấy"]
...
def register(va_core):
    ...
    va_core.handlers.insert(0, handler)
