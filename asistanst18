...
class SuKienManager:
    ...
    def tra_loi_bao_lau(self, cau_hoi):
        ...
        if ket_qua:
            for nd, so_ngay, tg in ket_qua:
                print(f"📆 '{nd}' diễn ra vào {tg}, cách đây {so_ngay} ngày.")
            return True
        else:
    ...
    def ghi_su_kien_nang_cao(self, cau_hoi):
        # Tìm số ngày trong câu kiểu "đã ... X ngày rồi"
        ...
        if match:
            ...
            # Lấy phần nội dung sự kiện bỏ "đã" và phần số ngày
...
class TroLyAo:
    ...
    def xu_ly_tra_loi(self, cau_hoi):
        ...
        # Xử lý câu sự kiện nâng cao dạng "đã ... X ngày rồi"
